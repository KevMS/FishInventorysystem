...
if(isset($_POST['update-customer'])){
    ...
    $sqli = "UPDATE customer SET fullname = '$updateCustomername', email = '$updateEmail', phone = '$updatePhone', address = '$updateAddress' WHERE customer_id = '$id';";
    $updated = $conn->query($sqli);
    if($updated == TRUE){
        $_SESSION['Updated'] = "Customer Updated Succesfully!";
...
<div class="container">
    <aside>
            <div class="nav">
                ...
                <a id="customer" class= "active" href="../../inc/customer.php"><span ><img src="../../icons/icons8-customers-64.png" alt=""></span><h3>Customers</h3></a>
...
<main>
    ...
    if($result->num_rows > 0){
        while($row = $result->fetch_assoc()){
            $editId = $row['customer_id'];
            $editCustomername = $row['fullname'];
            $editEmail = $row['email'];
            $editPhone = $row['phone'];
    ...
    <label class="btn" style="padding:10px;"><a href="customer.php">Back</a></label>
    <h1 style="text-align:center;"><?php echo $editCustomername;?> Details</h1>
    <div style="display:grid; grid-template-columns: 35rem auto ; margin-left:3rem; " class="inventory">
            <form action="#" enctype="multipart/form-data" method="POST">
            <input type="hidden" name="updateId" value = "<?php echo $editId; ?>">
            <label for="">Fullname</label>
            <input type="text" name="updateCustomername" value="<?php echo strval($editCustomername); ?>" > <br>
